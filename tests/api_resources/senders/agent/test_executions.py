...
class TestExecutions:
    ...
    def test_raw_response_retrieve(self, client: Zavudev) -> None:
        response = client.senders.agent.executions.with_raw_response.retrieve(
            execution_id="executionId",
            sender_id="senderId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Zavudev) -> None:
        with client.senders.agent.executions.with_streaming_response.retrieve(
            execution_id="executionId",
            sender_id="senderId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Zavudev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `sender_id` but received ''"):
            client.senders.agent.executions.with_raw_response.retrieve(
                execution_id="executionId",
                sender_id="",
            )
...
class TestAsyncExecutions:
    ...
    async def test_method_retrieve(self, async_client: AsyncZavudev) -> None:
        execution = await async_client.senders.agent.executions.retrieve(
            execution_id="executionId",
            sender_id="senderId",
        )
        assert_matches_type(ExecutionRetrieveResponse, execution, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncZavudev) -> None:
        response = await async_client.senders.agent.executions.with_raw_response.retrieve(
            execution_id="executionId",
            sender_id="senderId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncZavudev) -> None:
        async with async_client.senders.agent.executions.with_streaming_response.retrieve(
            execution_id="executionId",
            sender_id="senderId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncZavudev) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `sender_id` but received ''"):
            await async_client.senders.agent.executions.with_raw_response.retrieve(
                execution_id="executionId",
                sender_id="",
            )
