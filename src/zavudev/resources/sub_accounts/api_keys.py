...
from ...types.sub_accounts import api_key_create_params
from ...types.sub_accounts.api_key_list_response import APIKeyListResponse
from ...types.sub_accounts.api_key_create_response import APIKeyCreateResponse
...
class APIKeysResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        name: str,
        environment: Literal["live", "test"] | Omit = omit,
        ...
        return self._post(
            path_template("/v1/sub-accounts/{id}/api-keys", id=id),
    ...
    def revoke(
        ...
        *,
        ...
        return self._delete(
            path_template("/v1/sub-accounts/{id}/api-keys/{key_id}", id=id, key_id=key_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
