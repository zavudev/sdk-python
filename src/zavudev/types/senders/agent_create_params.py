...
class AgentCreateParams(TypedDict, total=False):
    ...
    Enable this to let the agent answer and place phone calls with Zavu's managed
    voice pipeline. Requires the Voice Agents feature to be enabled for your team.
    """
...
class Voice(TypedDict, total=False):
    ...
    Enable this to let the agent answer and place phone calls with Zavu's managed voice pipeline. Requires the Voice Agents feature to be enabled for your team.
    """
